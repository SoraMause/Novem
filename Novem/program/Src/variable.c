...
// sensor data 
t_sensor sen_front = {0,0,820,0,0,0}; // 前壁
t_sensor sen_fl;
t_sensor sen_fr;
t_sensor sen_l = {0,700,700,0,0,0}; // 横左壁
t_sensor sen_r = {0,700,650,0,0,0}; // 横右壁
...
// 変数
//---------------------------------------------------------------------
int16_t batt_analog;  // batt analog 
